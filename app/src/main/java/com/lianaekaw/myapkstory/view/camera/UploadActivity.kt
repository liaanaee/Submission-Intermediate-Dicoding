...
import com.lianaekaw.myapkstory.databinding.ActivityUploadBinding
import com.lianaekaw.myapkstory.di.getImageUri
import com.lianaekaw.myapkstory.di.reduceFileImage
import com.lianaekaw.myapkstory.di.uriToFile
...
class UploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!allPermissionsGranted()) {
            requestPermissionLauncher.launch(req_permission)
        }
