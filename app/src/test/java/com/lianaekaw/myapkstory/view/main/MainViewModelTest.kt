...
import com.lianaekaw.myapkstory.DataDummy
import com.lianaekaw.myapkstory.MainDispatcherRule
import com.lianaekaw.myapkstory.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val data: PagingData<ListStoryItem> = StoryPagingSources.snapshot(dummyQuote)
        val expectedQuote = MutableLiveData<PagingData<ListStoryItem>>()
        expectedQuote.value = data
        Mockito.`when`(repository.getTheStory()).thenReturn(expectedQuote)
